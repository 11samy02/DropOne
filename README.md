...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-v0.6.4--alpha-blue" alt="Version" />
...
| **Custom decks** | Host picks the deck in the lobby — **Classic**, **Merciless**, **Breeze**, or **Rapid** |
...
1. Download `DropOne-v0.6.4-alpha-win64.zip`
...
Steam lobby matchmaking filters by game version — all players in a match must share the same build tag (e.g. `v0.5.3-alpha`).
