...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-v0.4.0--alpha-blue" alt="Version" />
...
1. Download `DropOne-Windows-v0.4.0-alpha.zip`
...
Steam lobby matchmaking filters by game version — all players in a match must share the same build tag (e.g. `v0.4.0-alpha`).
